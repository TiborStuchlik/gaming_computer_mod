...
public class PClevel4turnoffBlock extends RedstoneModElements.ModElement {
	@ObjectHolder("redstone:p_clevel_4turnoff")
	public static final Block block = null;
	public PClevel4turnoffBlock(RedstoneModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("p_clevel_4turnoff");
		}
