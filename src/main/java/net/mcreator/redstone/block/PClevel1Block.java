...
public class PClevel1Block extends RedstoneModElements.ModElement {
	@ObjectHolder("redstone:p_clevel_1")
	public static final Block block = null;
	public PClevel1Block(RedstoneModElements instance) {
		super(instance, 8);
	}
