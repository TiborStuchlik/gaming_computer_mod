...
public class PClevel2Block extends RedstoneModElements.ModElement {
	@ObjectHolder("redstone:p_clevel_2")
	public static final Block block = null;
	public PClevel2Block(RedstoneModElements instance) {
		super(instance, 13);
	}
