...
public class PClevel4Block extends RedstoneModElements.ModElement {
	@ObjectHolder("redstone:p_clevel_4")
	public static final Block block = null;
	public PClevel4Block(RedstoneModElements instance) {
		super(instance, 33);
	}
