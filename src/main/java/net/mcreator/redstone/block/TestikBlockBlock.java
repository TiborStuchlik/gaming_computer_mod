...
import net.mcreator.redstone.procedures.TestikBlockRedstoneOnProcedure;
import net.mcreator.redstone.procedures.TestikBlockRedstoneOffProcedure;
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				{
					...
					TestikBlockRedstoneOnProcedure.executeProcedure($_dependencies);
				}
			} else {
				{
					java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					TestikBlockRedstoneOffProcedure.executeProcedure($_dependencies);
				}
			}
		}
	}
