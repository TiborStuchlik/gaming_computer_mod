...
public class PClevel2TurnOffBlock extends RedstoneModElements.ModElement {
	@ObjectHolder("redstone:p_clevel_2_turn_off")
	public static final Block block = null;
	public PClevel2TurnOffBlock(RedstoneModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("p_clevel_2_turn_off");
		}
