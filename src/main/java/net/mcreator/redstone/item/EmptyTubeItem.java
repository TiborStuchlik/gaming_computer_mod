...
public class EmptyTubeItem extends RedstoneModElements.ModElement {
	@ObjectHolder("redstone:empty_tube")
	public static final Item block = null;
	public EmptyTubeItem(RedstoneModElements instance) {
		super(instance, 18);
	}
