...
public class GlueInTubeItem extends RedstoneModElements.ModElement {
	@ObjectHolder("redstone:glue_in_tube")
	public static final Item block = null;
	public GlueInTubeItem(RedstoneModElements instance) {
		super(instance, 17);
	}
