...
public class GraphicCardLevel4Item extends RedstoneModElements.ModElement {
	@ObjectHolder("redstone:graphic_card_level_4")
	public static final Item block = null;
	public GraphicCardLevel4Item(RedstoneModElements instance) {
		super(instance, 36);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("graphic_card_level_4");
		}
