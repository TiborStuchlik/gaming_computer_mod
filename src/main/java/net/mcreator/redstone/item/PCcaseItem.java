...
public class PCcaseItem extends RedstoneModElements.ModElement {
	@ObjectHolder("redstone:p_ccase")
	public static final Item block = null;
	public PCcaseItem(RedstoneModElements instance) {
		super(instance, 9);
	}
