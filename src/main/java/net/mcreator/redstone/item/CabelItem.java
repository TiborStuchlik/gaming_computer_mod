...
public class CabelItem extends RedstoneModElements.ModElement {
	@ObjectHolder("redstone:cabel")
	public static final Item block = null;
	public CabelItem(RedstoneModElements instance) {
		super(instance, 21);
	}
