...
public class ProcessorItem extends RedstoneModElements.ModElement {
	@ObjectHolder("redstone:processor")
	public static final Item block = null;
	public ProcessorItem(RedstoneModElements instance) {
		super(instance, 10);
	}
